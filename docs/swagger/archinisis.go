...
type ArchDataUpsertRequest struct {
	NationalID   string                  `json:"national_id" example:"27578816"`
	FirstName    *string                 `json:"first_name,omitempty" example:"Petra"`
	LastName     *string                 `json:"last_name,omitempty" example:"Torvinen"`
	Initials     *string                 `json:"initials,omitempty" example:"PeTo"`
	DateOfBirth  *string                 `json:"date_of_birth,omitempty" example:"1994-01-01"`
	Height       *float64                `json:"height,omitempty" example:"175.0"`
	Weight       *float64                `json:"weight,omitempty" example:"72.0"`
...
type ArchMeasurementResponse struct {
	MeasurementGroupID *int32  `json:"measurement_group_id,omitempty" example:"2024010101"`
	MeasurementID      int32   `json:"measurement_id" example:"42"`
	Discipline         *string `json:"discipline,omitempty" example:"Sprint 100m"`
	SessionName        *string `json:"session_name,omitempty" example:"Morning session"`
	Place              *string `json:"place,omitempty" example:"Helsinki"`
