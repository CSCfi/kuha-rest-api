...
func New(fisAddr, utvAddr, authAddr, tietoevryAddr string, maxOpenConns, maxIdleConns int, maxIdleTime string) (*Database, error) {
	...
	return &Database{FIS: fisDB, UTV: utvDB, Auth: authDB, Tietoevry: tietoevryDB}, nil
}
